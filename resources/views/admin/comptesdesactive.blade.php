...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Listes Compte désactivés</h4>

    <!-- Basic Bootstrap Table -->
    <div class="card">
      <h5 class="card-header">Listes Compte désactivés</h5>
      ...
      @endif
        <table class="table">
          ...
          <tbody class="table-border-bottom-0">
            @foreach ($comptesdesactive as $item)
            <tr>
                <td>{{$item->nom}}</td>
                <td>{{$item->prenoms}}</td>
                <td>{{$item->email}}</td>
