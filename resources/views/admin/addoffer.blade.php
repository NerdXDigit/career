        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <form action="/espace/offreur/saveoffer" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-company">Niveau</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="niveau" name="niveau" id="basic-default-company" placeholder="" value="{{old('poste')}}">
                  @if ($errors->has('niveau'))
                  <div style="color: #f31818 !important" class="text-muted fs-7 danger">{{$errors->first('niveau')}} </div> 
                  @endif
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-company">Pays</label>
                <div class="col-sm-10">
                  <select class="form-select" id="exampleFormControlSelect1"  name="pays" aria-label="Default select example">
                  ...
                  @if ($errors->has('pays'))
                  <div style="color: #f31818 !important" class="text-muted fs-7 danger">{{$errors->first('pays')}} </div> 
                  @endif
                </div>
              </div>
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-company">Affiche</label>
                <div class="col-sm-10">
