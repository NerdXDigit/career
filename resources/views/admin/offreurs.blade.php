...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Listes offreurs</h4>

    <!-- Basic Bootstrap Table -->
    <div class="card">
      <h5 class="card-header">Listes offreurs</h5>
      ...
      @endif
        <table class="table" id="myTable">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <td>
                <a href="{{url('/espace/admin/offres/'.$item->id)}}">
                    <button type="button" class="btn rounded-pill btn-primary">Voir</button>
                </a>
            </td>
